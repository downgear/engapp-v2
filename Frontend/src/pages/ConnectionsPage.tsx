...
const ConnectionsPage = () => {
  ...
  const handleAddParent = async () => {
    ...
    try {
      ...
      toast.success("Đã tạo kết nối thành công!");
      setNewParentEmail("");
      ...
      const errorMessage = error instanceof Error ? error.message : "Không thể tạo kết nối";
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 pt-28 pb-8 max-w-4xl">
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            <h1 className="text-2xl font-bold text-foreground">Kết nối</h1>
            <p className="text-muted-foreground">
              Quản lý kết nối với phụ huynh và giáo viên
            </p>
          </div>
        </div>
            ...
            <CardHeader className="pb-3">
              <div className="flex items-center justify-between">
                ...
                <Dialog open={isAddParentOpen} onOpenChange={setIsAddParentOpen}>
                  ...
                  <DialogContent>
                    <DialogHeader>
                      <DialogTitle>Thêm kết nối phụ huynh</DialogTitle>
                      <DialogDescription>
                        Nhập email của phụ huynh để tạo kết nối. Phụ huynh cần có tài khoản trên hệ thống.
                      </DialogDescription>
                    </DialogHeader>
                    <div className="space-y-4 pt-4">
                      ...
                      >
                        {isSubmitting ? "Đang xử lý..." : "Gửi yêu cầu kết nối"}
                      </Button>
                    </div>
                  </DialogContent>
                </Dialog>
            ...
            <CardContent>
              {isLoading ? (
                ...
                <div className="text-center py-8">
                  ...
                  <p className="text-muted-foreground">Chưa có kết nối với phụ huynh</p>
                  <p className="text-sm text-muted-foreground mt-1">
                    Nhấn "Thêm kết nối" để liên kết với phụ huynh
                  </p>
                </div>
              )}
            </CardContent>
            ...
            <CardHeader className="pb-3">
              <div className="flex items-center justify-between">
                ...
                <Dialog open={isAddTeacherOpen} onOpenChange={setIsAddTeacherOpen}>
                  ...
                  <DialogContent>
                    <DialogHeader>
                      <DialogTitle>Thêm kết nối giáo viên</DialogTitle>
                      <DialogDescription>
                        Nhập email của giáo viên để tạo kết nối. Giáo viên cần có tài khoản trên hệ thống.
                      </DialogDescription>
                    </DialogHeader>
                    <div className="space-y-4 pt-4">
                      <div className="space-y-2">
            ...
            <CardContent>
              {isLoading ? (
                ...
                <div className="text-center py-8">
                  ...
                  <p className="text-muted-foreground">Chưa có kết nối với giáo viên</p>
                  <p className="text-sm text-muted-foreground mt-1">
                    Nhấn "Thêm kết nối" để liên kết với giáo viên
                  </p>
                </div>
              )}
            </CardContent>
