...
-- Admin user (seed first to ensure id = 1 is not taken if run fresh)
INSERT INTO users (email, password_hash, phone, full_name, role, avatar_url, is_locked) VALUES
('admin@lingriser.com', '123456', NULL, 'System Admin', 'admin', NULL, FALSE);
...
(1, 6, '09:00', TRUE), (1, 6, '10:00', TRUE), (1, 6, '11:00', TRUE), (1, 6, '14:00', TRUE), (1, 6, '15:00', TRUE), (1, 6, '16:00', TRUE),
(1, 7, '09:00', TRUE), (1, 7, '10:00', TRUE), (1, 7, '14:00', TRUE), (1, 7, '15:00', TRUE);

-- James (teacher_id = 2) - available on Saturday and Sunday
INSERT INTO teacher_availability (teacher_id, day_of_week, slot_start_time, is_available) VALUES
(2, 6, '10:00', TRUE), (2, 6, '11:00', TRUE), (2, 6, '13:00', TRUE), (2, 6, '14:00', TRUE), (2, 6, '19:00', TRUE), (2, 6, '20:00', TRUE),
(2, 7, '10:00', TRUE), (2, 7, '11:00', TRUE), (2, 7, '15:00', TRUE), (2, 7, '16:00', TRUE);

-- Emma (teacher_id = 4) - available on Saturday and Sunday
INSERT INTO teacher_availability (teacher_id, day_of_week, slot_start_time, is_available) VALUES
(4, 6, '09:00', TRUE), (4, 6, '10:00', TRUE), (4, 6, '11:00', TRUE), (4, 6, '17:00', TRUE), (4, 6, '18:00', TRUE),
(4, 7, '14:00', TRUE), (4, 7, '15:00', TRUE), (4, 7, '16:00', TRUE), (4, 7, '17:00', TRUE);

-- Michael (teacher_id = 5) - available on Saturday and Sunday
INSERT INTO teacher_availability (teacher_id, day_of_week, slot_start_time, is_available) VALUES
(5, 6, '13:00', TRUE), (5, 6, '14:00', TRUE), (5, 6, '15:00', TRUE), (5, 6, '16:00', TRUE),
(5, 7, '09:00', TRUE), (5, 7, '10:00', TRUE), (5, 7, '11:00', TRUE), (5, 7, '19:00', TRUE), (5, 7, '20:00', TRUE);
